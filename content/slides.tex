...
% % No video, with hyperlink to GitHub videos
% \begin{frame}{Training}{Simulation - Panda (Video Example)}
%     \centering
%     \scalebox{0.13}{%
%         \def \vidwidth{1000px}%
%         \def \vidheight{900px}%
%         \href{https://github.com/AndrejOrsula/master_thesis_presentation/blob/ign_jun_2021/videos/training_0.mp4}{\includegraphics[width=\vidwidth,height=\vidheight]{videos/training_0_0.png}}
%     }%
%     \scalebox{0.13}{%
%         \def \vidwidth{1000px}%
%         \def \vidheight{900px}%
%         \href{https://github.com/AndrejOrsula/master_thesis_presentation/blob/ign_jun_2021/videos/training_100.mp4}{\includegraphics[width=\vidwidth,height=\vidheight]{videos/training_100_0.png}}
%     }%
%     \scalebox{0.13}{%
%         \def \vidwidth{1000px}%
%         \def \vidheight{900px}%
%         \href{https://github.com/AndrejOrsula/master_thesis_presentation/blob/ign_jun_2021/videos/training_1000.mp4}{\includegraphics[width=\vidwidth,height=\vidheight]{videos/training_1000_0.png}}
%     }
% \end{frame}
...
% % No video, with hyperlink to YouTube video
% \begin{frame}{Trained Agent}{Simulation - Panda (Video Example)}
%     \centering
%     \vspace{-0.4cm}
%     \scalebox{0.25}{%
%         \def \vidwidth{1500px}%
%         \def \vidheight{800px}%
%         \href{https://www.youtube.com/watch?v=1-cudiW4eaU&list=PLzcIGFRbGF3Qr4XSzAjNwOMPaeDn5J6i1&index=1&t=0s}{\includegraphics[width=\vidwidth,height=\vidheight]{videos/sim_panda_0.png}}
%     }
% \end{frame}
...
%         \def \vidwidth{1500px}%
%         \def \vidheight{800px}%
%         \href{https://www.youtube.com/watch?v=1-cudiW4eaU&list=PLzcIGFRbGF3Qr4XSzAjNwOMPaeDn5J6i1&index=1&t=20s}{\includegraphics[width=\vidwidth,height=\vidheight]{videos/sim_ur5_rg2_0.png}}
%     }
% \end{frame}
...
%         \def \vidwidth{2240px}%
%         \def \vidheight{1000px}%
%         \href{https://www.youtube.com/watch?v=1-cudiW4eaU&list=PLzcIGFRbGF3Qr4XSzAjNwOMPaeDn5J6i1&index=1&t=44s}{\includegraphics[width=\vidwidth,height=\vidheight]{videos/sim2real_0.png}}
%     }
% \end{frame}
